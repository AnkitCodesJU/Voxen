                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="flex flex-col gap-2">
                        ...
                        <input
                            ...
                            className="w-full rounded bg-zinc-700/50 border border-zinc-600 px-4 py-3 text-white placeholder-zinc-500 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <div className="flex items-center gap-4">
                            <div className="h-16 w-16 rounded-full bg-zinc-800 border border-zinc-600 flex items-center justify-center text-xs text-zinc-500 overflow-hidden shrink-0">
                                {avatar ? (
                            ...
                            <label className="cursor-pointer rounded bg-zinc-800 px-4 py-2 text-sm font-medium text-white transition hover:bg-zinc-700 border border-zinc-600">
                                Choose Avatar
                                <input
                                    type="file"
                                    name="avatar"
